...
import RealEstatePaymentModel from "../models/estatePaymentModel";
import PaypalModel from "../models/paypalModel";

const paymentModel = new RealEstatePaymentModel();
...
class RealEstateService {
    ...
    async paymentWithPaypal(req: Request, res: Response, next: NextFunction) {
        ...
        try {
            ...
            const confirmPayment = await paymentModel.confirmPayment(savePayment.estateId as number);
    ...
    async confirmBankPayment(req: Request, res: Response, next: NextFunction) {
        ...
        try {
            ...
            const confirmPayment = await paymentModel.confirmPayment(taxBill.estateId as number);
