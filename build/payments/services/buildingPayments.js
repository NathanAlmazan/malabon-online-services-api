...
const buildingPaymentModel_1 = __importDefault(require("../models/buildingPaymentModel"));
const paypalModel_1 = __importDefault(require("../models/paypalModel"));
const paymentModel = new buildingPaymentModel_1.default();
    ...
    paymentWithPaypal(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const confirmPayment = yield paymentModel.confirmPayment(savePayment.buildingId);
    ...
    confirmBankPayment(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const confirmPayment = yield paymentModel.confirmPayment(taxBill.buildingId);
...
exports.default = BuildingPaymentService;
//# sourceMappingURL=buildingPayments.js.map