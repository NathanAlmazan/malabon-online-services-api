...
const paymentModel = new paymentModel_1.default();
...
class BusinessPayments {
    ...
    paymentWithPaypal(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const confirmPayment = yield paymentModel.confirmPayment(savePayment.businessId);
    ...
    getPaypalClientKey(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const clientKey = yield paypalModel.getClientToken();
...
exports.default = BusinessPayments;
//# sourceMappingURL=businessPayments.js.map